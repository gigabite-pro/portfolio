...
const MusicPlayer = ({ nodes, materials, floor, wallBack, wallLeft, cameraMode, setCameraMode }) => {
    ...
    return (
        <>
            <group
                ...
                scale={0.17}
            >
                <Html ref={html} position={[300, 200, -100]} distanceFactor={0.8} occlude={[floor, wallBack, wallLeft]} center pointerEvents="none">
                    <div className="label">Spotify 🎵</div>
                </Html>
                <mesh name="Cube" geometry={nodes.Cube.geometry} material={materials.main} castShadow receiveShadow position={[107.01, 51.81, -53.02]} rotation={[-1.57, 0, -0.17]} scale={1.28} />
                <mesh
                    name="Cylinder 21"
                    ...
                    scale={1.28}
                />
                <mesh name="Cylinder2" geometry={nodes.Cylinder2.geometry} material={materials.main} castShadow receiveShadow position={[109.87, 51.63, -93.44]} rotation={[0, 0, 0]} scale={1.28} />
                <mesh
                    name="Rectangle 22"
                    ...
                    scale={1.28}
                />
                <mesh name="red" geometry={nodes.red.geometry} material={materials.red} castShadow receiveShadow position={[-17.54, 45.91, -6.71]} rotation={[0, 0, 0]} scale={[0.72, 0.09, 0.72]} />
                <mesh
                    name="Cylinder3"
