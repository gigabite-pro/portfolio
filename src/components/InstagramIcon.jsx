    ...
    return (
        <>
            <group
                ...
                scale={10.81}
            >
                <Html ref={html} position={[2, 7, 10]} distanceFactor={0.8} occlude={[floor, wallBack, wallLeft]} center>
                    <div className="label">Instagram 📸</div>
                </Html>
                <group name="Cylinder043_1" position={[0, 3.02, 6]} rotation={[Math.PI / 2, 0, 0]} scale={0.69}>
                    <mesh name="Object_43" geometry={nodes.Object_43.geometry} material={nodes.Object_43.material} castShadow receiveShadow />
                </group>
                <group name="Cylinder042_2" position={[0, 3, 6]} rotation={[Math.PI / 2, 0, 0]} scale={0.84}>
                    <mesh name="Object_61" geometry={nodes.Object_61.geometry} material={nodes.Object_61.material} castShadow receiveShadow />
                </group>
                <group name="Cylinder023_3" position={[0, 3, 6]} rotation={[Math.PI / 2, 0, 0]} scale={0.84}>
                    <mesh name="Object_8" geometry={nodes.Object_8.geometry} material={nodes.Object_8.material} castShadow receiveShadow />
                </group>
            </group>
        </>
    );
